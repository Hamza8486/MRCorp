...
class PromoteBusiness extends StatefulWidget {
  const PromoteBusiness({super.key});
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(() {
                        return Get.put(HomeController()).userAdsLoader.value
                            ? Column(
                                children: [
                                  SizedBox(
                            ...
                            : Get.put(HomeController()).getAdsList.isEmpty
                                ? Column(
                                    children: [
                                      SizedBox(
                                        height: Get.height * 0.2,
                                                                ...
                                                                children: [
                                                                  ...
                                                                  AppText(
                                                                      title: timeago.format(DateTime.parse(
                                                                          (Get.put(HomeController()).getAdsList[index].adDate)
                                                                              .toString())),
                                                                      size: 12,
                                                                      fontWeight:
                                                                          FontWeight
      ...
      body: Column(
        children: [
          ...
          isKeyBoard
              ? SizedBox.shrink()
              : Obx(() {
                  return Get.put(HomeController()).adLoader.value
                      ? Center(
                          child: SpinKitThreeBounce(
                          ...
                          child: AppButton(
                            ...
                            onTap: () {
                              if (validateAds(context)) {
                                Get.put(HomeController()).updateAdLoader(true);
                                ApiManger().createAds(
                                    ...
                                    whatsapp:
                                        isWebsite != "" ? whatsappController.text : "",
                                    schedule: isSchedule,
